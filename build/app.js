...
},{"../config":13,"../parsers/template":51,"../util":60}],13:[function(require,module,exports){
module.exports = {
...
},{"../parsers/expression":49,"../util":60,"../watcher":64}],38:[function(require,module,exports){
var _ = require('../util')
var Path = require('../parsers/path')
...
},{"./config":66,"./routes":70,"./service/page_service":72,"./vue_filter/register_filter":86,"director":2}],66:[function(require,module,exports){
// Generated by CoffeeScript 1.9.2
var config;
...
},{"../config":66,"./../vue/blogs_vue":81,"./../vue/header_vue":82,"./../vue/site_des_vue":85}],68:[function(require,module,exports){
// Generated by CoffeeScript 1.9.2
...
},{"../config":66,"./../vue/header_vue":82,"./../vue/login_vue":83}],69:[function(require,module,exports){
// Generated by CoffeeScript 1.9.2
...
},{"../config":66,"./../vue/header_vue":82,"./../vue/register_vue":84}],70:[function(require,module,exports){
// Generated by CoffeeScript 1.9.2
...
},{"./route/index":67,"./route/login":68,"./route/register":69}],71:[function(require,module,exports){
// Generated by CoffeeScript 1.9.2
...
},{"./../config":66}],72:[function(require,module,exports){
// Generated by CoffeeScript 1.9.2
...
},{"./../config":66,"./../util/myutils":79,"./exchange_service":71}],73:[function(require,module,exports){
module.exports = '<div id="blog_content_window">\n    <form class="uk-form uk-form-horizontal">\n        <div>\n            <legend>Save a Blog</legend>\n            <div class="uk-alert uk-alert-warning" v-show="validationMessage != null">{{validationMessage}}</div>\n            <div class="uk-form-row">\n                <label class="uk-form-label">Title</label>\n\n                <div class="uk-form-controls">\n                    <input type="text" placeholder="" v-model="title" style="width: 80%">\n                </div>\n            </div>\n            <div class="uk-form-row">\n                <label class="uk-form-label">Content</label>\n\n                <div class="uk-form-controls">\n                    <textarea cols="" rows="12" placeholder="" v-model="content" style="width: 80%"></textarea>\n                </div>\n            </div>\n        </div>\n        <div class="uk-margin-large-top  uk-text-right">\n            <button class="uk-button uk-button-primary " type="button" v-on="click:save">Save</button>\n            <button class="uk-button " type="button" v-on="click:cancel">Cancel</button>\n        </div>\n\n    </form>\n</div>';
},{}],74:[function(require,module,exports){
module.exports = '<div id="blogs_div" class="uk-width-3-4 uk-align-center">\n    <button class="uk-button uk-button-success uk-margin-large-bottom " v-on="click:toAddBlog"><i class="uk-icon-plus"></i> Add a Blog</button>\n    <div id="no_blogs_div" class="uk-hidden">\n        <h2 class="uk-text-center uk-margin-large-top">No Blogs.</h2>\n    </div>\n    <div v-repeat="blog:blogs">\n        <article>\n            <h1 class="uk-article-title">{{blog.title}}</h1>\n            <p class="uk-article-meta">Write on {{blog.createTime | datetime}}</p>\n            <p>{{blog.content}}</p>\n            <div>\n                <button class="uk-button uk-button-mini" v-on="click:deleteBlog(blog)"><i class="uk-icon-delete"></i> Delete</button>\n                <button class="uk-button uk-button-mini" v-on="click:toUpdateBlog(blog)"><i class="uk-icon-update"></i> Update</button>\n            </div>\n            <hr class="uk-article-divider">\n        </article>\n    </div>\n</div>\n\n<div id="blog_content_window" class="uk-modal">\n    <div class="uk-modal-dialog uk-modal-dialog-large">\n        <a class="uk-modal-close uk-close"></a>\n        <div id="blog_content_container"></div>\n    </div>\n</div>';
},{}],75:[function(require,module,exports){
module.exports = '<div name="header" class="uk-margin-large-bottom">\n    <nav class="uk-navbar">\n        <a class="uk-navbar-brand" href="/#/index" >Sample Blog</a>\n        <div class="uk-navbar-flip">\n            <ul class="uk-navbar-nav">\n                <li class="{{userInfo.login?\'uk-hidden\':\'\'}}"><a href="/#/register">Register</a></li>\n                <li class="{{userInfo.login?\'uk-hidden\':\'\'}}"><a href="/#/login">Login</a></li>\n                <li class="uk-parent {{userInfo.login?\'\':\'uk-hidden\'}}" data-uk-dropdown>\n                    <a href="">Hello, {{userInfo.name}}</a>\n                    <div class="uk-dropdown uk-dropdown-navbar">\n                        <ul class="uk-nav uk-nav-navbar">\n                            <li><a v-on="click:logout">Logout</a></li>\n                        </ul>\n                    </div>\n                </li>\n            </ul>\n        </div>\n    </nav>\n</div>';
},{}],76:[function(require,module,exports){
module.exports = '<div id="login_div" class="uk-align-center" style="width: 380px;">\n    <form class="uk-panel uk-panel-box uk-form" name="login_form" method="post">\n        <h3 class="uk-panel-title ">Login</h3>\n\n        <div class="uk-form-row">\n            <input name="email" class="uk-width-1-1 uk-form-large" type="text" v-model="email">\n        </div>\n        <div class="uk-form-row ">\n            <input name="password" type="password" class="uk-width-1-1 uk-form-large" type="text" v-model="password">\n        </div>\n        <p name="loginMessage" class="uk-form-help-block" style="color: red;font-size:smaller;height: 25px"></p>\n\n        <div class="uk-form-row uk-text-small">\n            <label class="uk-float-left"><input name="remember_me" type="checkbox" v-model="rememberMe"> Remember\n                Me</label>\n            <a class="uk-float-right uk-link uk-link-muted">Forgot Password?</a>\n        </div>\n        <div class="uk-form-row">\n            <a class="uk-width-2-5 uk-button uk-button-primary uk-button-large uk-align-center" v-on="click:signIn">Login</a>\n        </div>\n        <hr class="uk-margin-top">\n        <div class="uk-form-row uk-text-small uk-text-center">\n            Login via\n            <a class=" uk-link uk-link-muted" v-on="click:loginWeibo">Weibo</a>\n            /\n            <a class=" uk-link uk-link-muted" v-on="click:loginFb">Facebook</a>\n        </div>\n    </form>\n</div>';
},{}],77:[function(require,module,exports){
module.exports = '<div id="register_div" class="uk-align-center" style="width: 500px;">\n    <form class="uk-panel uk-panel-box uk-form uk-form-stacked " name="register_form">\n        <h3 class="uk-panel-title uk-text-bold uk-margin-large-bottom uk-text-center">Register</h3>\n\n        <div class="uk-form-row" >\n            <label class="uk-form-label uk-text-large " >Email</label>\n            <input name="email" class="uk-form-large uk-form-width-large "  type="text" placeholder="" v-model="email" v-on="blur:validEmail">\n            <p name="emailMessage" class="uk-form-help-block" style="color: red"></p>\n        </div>\n        <div class="uk-form-row">\n            <label class="uk-form-label uk-text-large ">Name</label>\n            <input name="nickname" class="uk-form-large uk-form-width-large " type="text" placeholder=""  v-model="displayName" v-on="blur:validNickName">\n            <p name="displayNameMessage" class="uk-form-help-block" style="color: red"></p>\n        </div>\n        <div class="uk-form-row">\n            <label class="uk-form-label uk-text-large ">Password</label>\n            <input name="password" type="password" class="uk-form-large uk-form-width-large " type="text" placeholder="" v-model="password" v-on="blur:validPassword">\n            <p name="passwordMessage" class="uk-form-help-block" style="color: red"></p>\n        </div>\n        <div class="uk-form-row">\n            <label class="uk-form-label uk-text-large ">Password Again</label>\n            <input name="password_repeat" type="password" class="uk-form-large uk-form-width-large " type="text" placeholder="" v-model="passwordRepeat" v-on="blur:validRepeatPassword">\n            <p name="repeatPasswordMessage" class="uk-form-help-block" style="color: red"></p>\n        </div>\n\n        <div class="uk-form-row uk-container-center">\n            <a class="uk-width-2-5 uk-button uk-button-danger uk-button-large uk-align-center" v-on="click:signUp" >Sign\n                Up</a>\n        </div>\n    </form>\n</div>';
},{}],78:[function(require,module,exports){
module.exports = '<div class="uk-flex uk-flex-center">\n    <div class="uk-width-3-4">\n        <h1 class="uk-heading-large uk-text-center uk-margin-large-bottom">Welcome to sample blog!</h1>\n        <p class="uk-text-large">This sample blog show you how to use oceanclouds api and back services to build an web application.</p>\n        <p class="uk-text-large">This application use standard user authorize back service, weibo user authorize back service, facebook back service to register and login.</p>\n        <p class="uk-text-large">This application use data persistence back service to store blog data.</p>\n        <p class="uk-text-large">You can use chrome developer tools or firefox firedebug to watch the data exchange between your browser and back service. </p>\n        <p class="uk-text-large">This application is a github static page https://github.com/changsure/ocean_sample.</p>\n    </div>\n</div>';
...
},{"../template/blog_content.html":73,"./../config":66,"./../service/exchange_service":71,"./../util/myutils":79,"vue":63}],81:[function(require,module,exports){
// Generated by CoffeeScript 1.9.2
...
},{"../template/blogs.html":74,"./../config":66,"./../service/exchange_service":71,"./../util/myutils":79,"./blog_content_vue":80,"vue":63}],82:[function(require,module,exports){
// Generated by CoffeeScript 1.9.2
...
},{"../template/header.html":75,"./../config":66,"./../service/exchange_service":71,"./../util/myutils":79,"vue":63}],83:[function(require,module,exports){
// Generated by CoffeeScript 1.9.2
  ...
  methods: {
    signIn: function() {
      ...
      if ((this.$data.email == null) || (this.$data.password == null)) {
        ...
        return exchangeService.loginAccount(loginUser, function(err, appUserAccessToken) {
          if ((err != null)) {
            return $("form[name='login_form'] [name='loginMessage']").html(err.errorMessage);
          } else {
            return exchangeService.fetchOceanContext(appUserAccessToken, function(err) {
              if ((err != null)) {
                return myutils.showErrorNoticeWindow(err.errorMessage);
              } else {
...
},{"../config":66,"../template/login.html":76,"./../service/exchange_service":71,"./../util/myutils":79,"vue":63}],84:[function(require,module,exports){
// Generated by CoffeeScript 1.9.2
...
},{"../config":66,"../template/register.html":77,"./../service/exchange_service":71,"./../util/myutils":79,"vue":63}],85:[function(require,module,exports){
// Generated by CoffeeScript 1.9.2
...
},{"../template/site_des.html":78,"./../config":66,"./../service/exchange_service":71,"./../util/myutils":79,"vue":63}],86:[function(require,module,exports){
// Generated by CoffeeScript 1.9.2
